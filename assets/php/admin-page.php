    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold active"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Fuel Menu</a>
            </li>
                <li class="no-padding">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Fuel Menu</h5>
              </div>
            </div>
          </div>
        </div>
		  ...
		  <form class="formValidate" id="formValidate" method="post" action="routers/menu-router.php" novalidate="novalidate">
            <div class="row">
              ...
              <div>
				...
				{
					$img_src = './images/'.$row['product_img'];
					...
					echo '<td><div class="input-field col s12 ">'.
								'<img src='.$img_src.' height="80px" width="80px" >'.
								'<form method="POST" action="routers/change-image1.php" enctype="multipart/form-data">
								  	<input type="hidden" name="size" value="1000000">
										<input type="hidden" name="product_id" value='.$product_id.'>

									  <input type="file" name="uploadfile" value="" />
										<div>
								  		<input class="" type="submit" name="upload" value="Change Image">
								  	</div>
								</form>';
...
<table>
				...
				<?php
					...
					echo '<td>';
					echo '<input type="file" name="uploadfile" value="" /> </td>';
					echo '<td></tr>';
				?>
                    </tbody>
</table>
