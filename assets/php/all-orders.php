    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Fuel Menu</a>
            </li>
                <li class="no-padding">
                ...
                <div>
					...
					while($row = mysqli_fetch_array($sql))
					{
						...
						echo '<li class="collection-item avatar">
                              ...
                              <span class="collection-header">Order ID. '.$row['id'].'</span>
                              <p><strong>Date:</strong> '.$row['date'].'</p>
                              <p><strong>Delivery Slot:</strong> '.$row['delivery_slot'].'</p>
						...
						while($row1 = mysqli_fetch_array($sql1))
						{
                            ...
                            <div class="col s2">
                            <span>'.$row1['quantity'].' Litre(s)</span>
                            </div>
                            <div class="col s3">
