    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold active"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Order Fuel</a>
            </li>
                <li class="no-padding">
      ...
      <section id="content">
        ...
        <!--start container-->
        <div class="container">
          <p class="caption">Order your fuel here.</p>
            ...
            <div class="row">
              ...
              <div>
				...
				while($row = mysqli_fetch_array($result))
				{
					...
					echo '<tr>
									<td>'.$row["name"].'</td>'.
									'<td> <img src='.$img_src.' height="100px" width="100px" > </td>'.
									'<td>'.$row["price"].'</td>';
