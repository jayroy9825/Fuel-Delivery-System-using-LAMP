      ...
      <form method="post" action="routers/router.php" class="login-form" id="form">
        <div class="row">
          <div class="input-field col s12 center">
            <p class="center login-form-text">Login for Fuel Ordering System</p>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="input-field col s6 m6 l6">
            <p class="margin medium-small">New User? <br><a href="register.php"> <b>Register Now!</b></a></p>
          </div>
        </div>
        </div>
		...
		<div class="row" style="text-align : center; padding-top: 30px;">
			<a href="../../index.html" class="button button5">Back To Home</a>
		</div>
