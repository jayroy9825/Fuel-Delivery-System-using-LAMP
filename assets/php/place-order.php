                    ...
                    <form class="formValidate col s12 m12 l6" id="formValidate" method="post" action="confirm-order.php" novalidate="novalidate">
                      <div class="row">
                        <div class="input-field col s12">
													...
													<label for="delivery_slot">Select Delivery Slot</label><br><br>
													<select id="delivery_slot" name="delivery_slot">
															...
															<option value="Any Time between 9AM to 5PM">Any time between 9AM to 5PM</option>
