...
echo $delivery_slot."<br>";

$total = $_POST['total'];
	$sql = "INSERT INTO orders (customer_id, payment_type, delivery_slot, address, total, description) VALUES ($user_id, '$payment_type', '$delivery_slot', '$address', $total, '$description')";
